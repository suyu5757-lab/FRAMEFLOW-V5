...
def main() -> int:
    ...
    if not run_id or not run_id.startswith("T03-TRIPLE-GATE-"):
        raise SystemExit("run id must be a fresh T03-TRIPLE-GATE-* id")
    ...
    b0 = build_candidate_evidence(
        ...
        schema_contract_version="runtime-mvp:5.3.2",
        backend_opened=False,
        validation=validate_candidate(candidate_b),
